// Add new projects here — the carousel pills and detail panel
...
export const projects = [
  ...
  {
    id: 'portfolio',
    name: 'Gongonet Website',
    tagline: 'Gongonet Website',
    description:
      'The personal portfolio you are looking at right now — a static React site documenting IT support, networking and web development experience, deployed on GitHub Pages. www.gongonet.co.za',
    technologies: ['Wordpress', 'Php', 'JavaScript', 'CSS'],
    image: '/images/portfolio.svg',
    //github: 'https://gongonet.co.za',
    demo: '',
    featured: false,
  },
]
